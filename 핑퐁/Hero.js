class Hero extends GameObject{
    constructor(container,x,y,width,height,velX,velY,bg,border){
        super(container,x,y,width,height,velX,velY,bg,border);
        //4개의 센서를 보유하자
        ...
        this.div.style.backgroundImage = 'url("images/cookie.png")';
        this.div.style.backgroundSize = 'contain'; // 또는 'cover'
    }
    //오버라이딩 하자
    tick(){
        this.x+=this.velX;
